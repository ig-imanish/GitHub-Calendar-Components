...
function highlightCode(code: string): string {
  ...
  for (let m; (m = re.exec(html)) !== null; ) {
    ...
    parts.push(m[0]);
    kinds.push(
      m[0].startsWith("//") || m[0].startsWith("/*") ? "comment" : "string",
    );
    ...
    if (i % 2 === 1) {
      ...
      parts[i] = parts[i]
        ...
        .replace(/\b([a-zA-Z_]\w*)\b/g, (m) =>
          KEYWORDS.has(m) ? `<span style="color:#c678dd">${m}</span>` : m,
        );
    }
  }
  return parts.join("");
    ...
    >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          >
            ...
            <input
              ...
              onChange={(e) =>
                setConfig({ ...config, labelText: e.target.value })
              }
          ...
          >
            ...
            <input
              ...
              onChange={(e) =>
                setConfig({ ...config, totalLabel: e.target.value })
              }
      ...
      >
        ...
        >
          ...
          <a
            href="https://github.com/ig-imanish"
            target="_blank"
            rel="noreferrer"
            style={{ color: "#555", fontSize: "13px", textDecoration: "none" }}
          >
